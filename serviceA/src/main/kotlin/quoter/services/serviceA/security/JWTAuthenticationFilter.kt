...
class JWTAuthenticationFilter(
    ...
    override fun successfulAuthentication(req: HttpServletRequest,
        ...
        val token = JWT.create()
                ...
                .withExpiresAt(Date(System.currentTimeMillis() + conf.security.expirationTime.toInt()))
                .sign(HMAC512(conf.security.secret.toByteArray()))
        res.addHeader(conf.security.headerString, conf.security.tokenPrefix + token)
    }
}